...
#-----------------------------------------------------------------------------
#' Ð???t m???t quân h???u cho tru???c m???t vecto v??? trí c???a các quân h???u hi???n t???i
#'
...
#' Ð??? t???o t???t c??? các gi???i pháp, hãy chuy???n vào m???t vecto tr???ng (m???c d???nh)
#'
...
place_queen <- function(queens=c()) { 
  ...
  # Ð???i v???i m???i quân h???u dã có trên bàn c???
  ...
  # Ð???i v???i m???i v??? trí có th???, hãy th??? và d???t m???t quân h???u
  possible_placements %>% 
